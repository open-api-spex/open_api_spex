defmodule OpenApiSpex.Operation do
  ...
  """
  @spec request_body(String.t(), String.t(), Schema.t() | Reference.t() | module, keyword) ::
          RequestBody.t()
  ...
  """
  @spec response(String.t(), String.t(), Schema.t() | Reference.t() | module, keyword) ::
          Response.t()
  ...
  """
  @spec cast(Operation.t(), Conn.t(), String.t() | nil, %{String.t() => Schema.t()}) ::
