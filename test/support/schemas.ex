  ...
  defmodule User do
    OpenApiSpex.schema %{
      ...
      properties: %{
        ...
        inserted_at: %Schema{type: :datetime, description: "Creation timestamp", format: :'date-time'},
        updated_at: %Schema{type: :datetime, description: "Update timestamp", format: :'date-time'}
      },
      required: [:name, :email],
